...
root_bg = Path("shapes_dataset_bg")
root_random = Path("shapes_dataset_random")

train_ds = ShapesDataset(root / "train", transform=transform)
val_ds = ShapesDataset(root / "val", transform=transform)

test_bg = ShapesDataset(root / "test", transform=transform)
test_random = ShapesDataset(root / "test", transform=transform)

test_bg_loader = DataLoader(test_bg, batch_size=32, shuffle=True, num_workers=0)
test_random_loader = DataLoader(test_random, batch_size=32, shuffle=True, num_workers=0)
...
show_predictions(test_bg_loader, model)
show_predictions(test_random_loader, model)